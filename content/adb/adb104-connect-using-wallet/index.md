...
layout: single
header:
  teaser: "../adb104-connect-using-wallet/img1_3.png"
  overlay_image: "../adb104-connect-using-wallet/img1_3.png"
...
+ SQL Developerを使用した接続を行いたい場合には、当該クライアントツールがインストール済みであること。インストールは[こちら](https://www.oracle.com/jp/tools/downloads/sqldev-downloads.html)から<br>
...
[1. クレデンシャル・ウォレットのダウンロード](#anchor1) でダウンロードしたファイルを"Drag & Drop"します。
...
Database Actionsを使った接続については、[こちら](../adb101-provisioning/)をご確認ください。
